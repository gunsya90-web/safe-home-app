...
(function (SAFEHOME) {
  ...
  SAFEHOME.RESULTS = {
    ...
    B: {
      icon: '🏠', cls: 'r-wait', title: '세대 내에서 대기하세요',
    ...
    C: {
      icon: '🛡️', cls: 'r-wait', title: '세대 내 대피공간으로 이동하세요',
      ...
      cards: [
        ...
        { type: 'info', h: '📞 지금 바로', items: ['119에 대피공간으로 이동했음을 알려주세요'] }
      ],
      howto: {
        title: '🛡️ 대피공간 이용 방법',
        steps: [
    ...
    D: {
      icon: '⬇️', cls: 'r-info', title: '하향식 피난구로 아래 세대로 이동하세요',
    ...
    E: {
      icon: '🚪', cls: 'r-wait', title: '경량칸막이로 옆 세대로 대피하세요',
    ...
    F: {
      icon: '📡', cls: 'r-danger', title: '구조 요청 후 대기하세요',
    ...
    G: {
      icon: '🏢', cls: 'r-info', title: '상황에 따라 옥상 대피를 검토하세요',
